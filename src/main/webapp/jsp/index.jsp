...
String b2csvTitle="<a href=\"b2csv.jsp\">Download CSV list of Building Blocks</a>";
String b2csvInstruction="This will download a CSV file listing all installed Building Blocks, with an extra column to indicate if the installation WAR file was found on the filesystem.\n"
        +"</br>This report can be used as the basis for B2 comparison or for your Integrations Worksheet. ";
